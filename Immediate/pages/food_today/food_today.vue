<template>
	<view class="content">
		...
		<view class="food">
			<view class="sonfood" style="background:#fcf5ef                 ">
				<uni-card class="card" isShadow="true" scroll-y="true"style="background-color: #fcf5ef;">
					...
					<!-- <view class="space" style="height: 10px;"></view> -->
					<view class="number" >
						<uni-list class="list"style="background:#fcf5ef ">
			...
			<view class="sonfood" style="background:#fcf5ef ">
				<uni-card class="card" isShadow="true" scroll-y="true"style="background:#fea735">
					<form @submit="formSubmit" @reset="formReset">
						<view class="uni-form-item uni-column">
					...
					<!-- <view class="space" style="height: 10px;"></view> -->
					<view class="number">
						<uni-list class="list" style="background:#fea735">
			...
			<view class="sonfood" style="background:#fcf5ef ">
				<uni-card class="card" isShadow="true" scroll-y="true" style="background:#00c3ff">
					<form @submit="formSubmit" @reset="formReset">
						<view class="uni-form-item uni-column">
					...
					<!-- <view class="space" style="height: 10px;"></view> -->
					<view class="number">
						<uni-list class="list" style="background:#00c3ff" >
