<template>
    <view class="daren">
        ...
        <view class="wandering">
            <view class="wandering-title">健身小常识</view>
            <view class="wandering-content">
                <view class="wandering-div" v-for="(item, index) in 10" :key="index">
                    <view class="wandering-top">
                        <image src="https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1605871082389&di=6d7c62dfb2e849fd63cf1ae8c7db6903&imgtype=0&src=http%3A%2F%2F5b0988e595225.cdn.sohucs.com%2Fimages%2F20171021%2Fa3bf958fdb54478cbb65779104dd82eb.jpeg" mode="widthFix" class="wandering-image"></image>
